...
echo 1. 레지스트리 편집 제한 정책 해제 시도
echo 2. Chrome 및 VSCode 최신 버전 설치 (사용자 수준)
echo 3. Chrome 시작 페이지를 https://github.com 으로 설정
echo.
echo 잠시 기다려 주세요...
echo.

:: 다운로드 및 설치를 위한 임시 폴더 설정
...
:: 1. 레지스트리 편집 제한 해제 시도
echo [1/5] '레지스트리 편집 제한' 정책을 해제합니다...
